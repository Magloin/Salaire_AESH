...
function CodePostal() {
    ...
    return (<Card>
            <h2 className=" text-center font-extrabold mb-2 max-sm:text-xs">Selection des Informations</h2>
            <div className="text-center text-2xl mb-2 pb-1 max-sm:text-xs max-sm:mb-0">
