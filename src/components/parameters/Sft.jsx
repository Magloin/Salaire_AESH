...
function Sft() {
    ...
    return ( <Card>
        <h2 className="text-lg text-left pl-1.5 font-extrabold max-sm:text-xs lg:text-xl md:text-sm md:text-sm xl:text-2xl xl:pl-3">SFT</h2>
        <Checkbox leftValue={"Non"} rightValue={"Oui"} defaultValue={hasSft} setNewValue={sethasSftNewValue}/>
            { hasSft &&
                <div>
                   
                    <Card>
                        <h2 className=" pl-2 text-left text-lg xl:text-xl font-bold md:text-sm">Nb d'enfant de moins de 20 ans</h2>
