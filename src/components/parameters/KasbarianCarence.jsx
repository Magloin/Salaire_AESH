    ...
    return (<div className="Flex self-center max-sm:text-xs max-sm:pb-64">
        <div className="text-xl bg-zinc-300 border-solid border-4 border-gray-600  pl-2 rounded-tr-md">
            ...
            <Card>
                ...
                <p>Il y a <span className="font-bold text-red-500">3</span> <span className="font-bold text-red-500">Jours</span> de carence et <span className="text-red-500 font-bold">{input.heal-3}</span> jours à 90% de traitement</p></Card>
            <Card>
                <div className=" text-center">
                    <div >
                        <p className="text-center">il sera retenu  pour les {input.heal} jours de maladie  : <span className="font-bold">{output.threeDayCarenceSalaryNetLost.toFixed(2)} €</span> </p>  
                    </div>
                </div>
            </Card>
            <Card><p className="text-center"> Votre salaire perçu sera de <span className="font-bold text-red-500">{output.threeDayCarenceRealSalary.toFixed(2)}</span> €  </p></Card>
            <Card> <p className="text-center">Soit une perte de revenue de <span className="font-bold text-red-500">{output.TreeDayCarenceLost.toFixed(2)}</span> % </p> </Card>
