...
function KasbarianCarence() {
    ...
    return (<div className="Flex self-start max-sm:text-xs ">
        <div className="text-xl bg-zinc-300 border-solid border-4 border-gray-600  pl-3 rounded-tr-md max-sm:pl-0.5 max-sm:pr-0">
            ...
            <Card>
                 <div className="text-center px-2">
                    <p>Salaire :<br/> <span className="font-bold"> {data.salaryOutput.aPercevoir.toFixed(2)}€ </span> <span className="text-red-500 font-bold max-sm:text-xs"></span> </p>      
                </div>        
            </Card>
            <Card>
                <p className="text-center"> Arrêt maladie :<br/> <span  className="font-bold">{input.heal} jours </span></p>
            ...
            <Card>
                <div className=" text-center">
                    <div >
                        <p className="text-center pl-2 pr-2 pt-1 pb-1">{input.heal} jours de maladie  :<br/> <span className="font-bold">{output.threeDayCarenceSalaryNetLost.toFixed(2)} €</span> de retenu </p>  
                    </div>
                </div>
            </Card>
